          ...
          <DropdownMenuContent className="bg-white border-border shadow-xl min-w-[320px] p-2">
            <div className="flex flex-row">
              <div className="w-72">
                {[
                  {
                    name: "Industrial Resin Flooring Solutions",
                    path: "/services/industrial-resin",
                  },
                  {
                    name: "Liquid Waterproofing Solutions",
                    path: "/services/liquid-waterproofing",
                  },
                  { name: "Anti-Slip Solutions", path: "/services/anti-slip" },
                  {
                    name: "Concrete Pool Coating Solutions",
              ...
              {[
                  {
                    ...
                    path: "/services/concrete-repairs",
                  },
                  {
                    name: "Interior Epoxy Floors",
                    path: "/services/interior-epoxy",
                  },
      ...
      {isMobileMenuOpen && (
        <div className="absolute top-full left-0 right-0 bg-white border-b shadow-2xl md:hidden animate-in slide-in-from-top duration-300">
          <div className="flex flex-col p-6 gap-4">
            <Link
              href="/"
              className="text-lg font-bold text-primary py-2 border-b border-muted"
            ...
            <div className="flex flex-col gap-2">
              ...
              {[
                ...
                <Link
                  key={i}
                  href={s.path}
                  className="text-primary font-medium py-2 pl-4 border-l-2 border-muted hover:border-accent"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  {s.name}
                </Link>
