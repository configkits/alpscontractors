      ...
      <section className="relative h-[400px] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center text-white">
          ...
          <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto italic">
            Auckland-based specialists in high-performance industrial resin
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
                <p>
                  ALPS Contractors is a New Zealand-based specialist contractor
                  delivering high-performance industrial resin flooring,
                  waterproofing, and protective coating systems.
                </p>
                <p>
                  With over 25 years of industry experience we provide hands-on
                  leadership and technical expertise, ensuring rigorous quality
                  control, full compliance, and professional project delivery
                  from specification through to completion.
                </p>
                <p className="font-serif italic border-l-4 border-accent pl-6 text-primary">
                  Our focus is simple: Quality finishes built to last — every
                  time.
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-8 border-none shadow-xl bg-white group hover:bg-primary transition-colors duration-500">
              <CardContent className="p-0">
                <Eye
                  ...
                  size={48}
                />
                <h4 className="text-2xl font-serif mb-4 group-hover:text-white transition-colors">
                  Our Vision
                </h4>
                <p className="text-muted-foreground group-hover:text-white/70 transition-colors text-lg italic">
                  To be the leading contractor in industrial resin solutions,
            ...
            <Card className="p-8 border-none shadow-xl bg-white group hover:bg-primary transition-colors duration-500">
              <CardContent className="p-0">
                ...
                <p className="text-muted-foreground group-hover:text-white/70 transition-colors text-lg italic">
                  To provide innovative, reliable, and sustainable flooring and
                  waterproofing solutions that enhance the safety,
                  functionality, and longevity of industrial and commercial
                  spaces.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-white overflow-hidden relative">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mb-16">
            ...
            <h3 className="text-3xl md:text-5xl font-serif text-primary mb-8">
              Why Choose Us?
            </h3>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Our commitment to quality craftsmanship, technical expertise, and
              long-lasting performance ensures every project meets the highest
              standards—giving you confidence and peace of mind.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Full adherence to NZBC and WorkSafe standards.",
              },
              {
                icon: Zap,
                title: "Fast Turnaround",
                desc: "Advanced fast-cure systems to minimize downtime.",
              },
              {
                icon: Clock,
                title: "Proven Durability",
                desc: "Systems designed for extreme industrial wear.",
              },
              {
                icon: Users,
                title: "Expert Leadership",
                desc: "Hands-on project management from 25+ years experience.",
              },
            ].map((item, i) => (
              <div key={i} className="space-y-4">
                ...
                <h5 className="text-xl font-serif text-primary">
                  {item.title}
                </h5>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="lg:w-1/2 grid grid-cols-3 gap-4">
              {[
                ...
                <div
                  key={i}
                  className="bg-white/5 border border-white/10 p-4 rounded-xl text-center text-[10px] font-bold uppercase tracking-widest text-white/40 hover:text-accent hover:border-accent transition-all cursor-default"
                >
                  {partner}
                </div>
              ))}
